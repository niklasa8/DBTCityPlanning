...
%         end
        ...
        if car == 1 && bic==1 && bus==1
            ...
            elseif data_umea.way(i).parking == 0 && data_umea.way(i).bicycle == 0 && data_umea.way(i).highway == 0 && data_umea.way(i).cycleway == 0%&& data_umea.way(i).bus == 0
                set(test.ch(n_ways - i + 1),'Color',handles.c11);
            else
                set(test.ch(n_ways - i + 1),'Color','k');
            end        
        ...
        elseif car == 1 && bic==0 && bus==0
            ...
            elseif data_umea.way(i).highway == 1 && data_umea.way(i).bicycle == 1 && others==1%&& data_umea.way(i).bus == 0 x
                    set(test.ch(n_ways - i + 1),'Color',handles.c);
            elseif data_umea.way(i).highway == 1 && data_umea.way(i).bicycle == 0 && others==1%&& data_umea.way(i).bus == 1 x
                    set(test.ch(n_ways - i + 1),'Color','r');
        ...
        if one==1
            if data_umea.way(i).oneway == 1
                set(test.ch(n_ways - i + 1),'LineStyle', '--');
                X(j) = data_umea.node(graph_data.id_map(data_umea.way(i).ndref{1})).lon;
                Y(j) = data_umea.node(graph_data.id_map(data_umea.way(i).ndref{1})).lat;
                %set(test.ch(n_ways - i + 1), '*m','MarkerSize', 20)
%                set(line, 'LineStyle', '--');
...
%                 end
    ...
    elseif handles.footway  == 1
        a=3
        set(test.ch(n_ways - i + 1),'Color',handles.c9,'LineStyle', ':' )
