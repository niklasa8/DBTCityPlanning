...
testf.travBike = str2double(get(handles.travBike,'String'));
testf.travBus = str2double(get(handles.travBus,'String'));
testf.travCar = str2double(get(handles.travCar,'String'));

testf.gcosts = get(handles.sliderCosts,'value');
testf.gtime = get(handles.sliderTime,'value');
testf.useG = handles.useG;
