...
%      applied to the GUI before rv_OpeningFcn gets called.  An
...
% Last Modified by GUIDE v2.5 03-Dec-2014 21:25:49
...
if isfield(testf,'handlesrv') == 0;
    ...
    set(handles.pop4,'Value',4);
    set(handles.pop5,'Value',5);
    set(handles.pop6,'Value',6);
    set(handles.pop7,'Value',7);
    set(handles.pop8,'Value',8);
    set(handles.pop9,'Value',9);
    set(handles.pop10,'Value',10);
    set(handles.pop11,'Value',11);
    
    set(handles.bic,'Value',1);
    ...
    set(handles.nonodes,'Value',test3.nonodes);
    set(handles.footway,'Value',test3.footway);
...
% --- Executes on button press in footway.
function footway_Callback(hObject, eventdata, handles)
% hObject    handle to footway (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of footway


% --- Executes on button press in bus.
function bus_Callback(hObject, eventdata, handles)
% hObject    handle to bus (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of bus
...
% Hint: get(hObject,'Value') returns toggle state of bic
%if 
...
% Hints: contents = cellstr(get(hObject,'String')) returns pop10 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from pop10
...
% hObject    handle to pop11 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns pop11 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from pop11
...
% --- Executes on button press in nonodes.
