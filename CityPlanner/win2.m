...
set(handles.carMult,'string',testf.carDef);
set(handles.bikeSpeed,'string',testf.bikeDef);
set(handles.walkSpeed,'string',testf.walkDef);
set(handles.parkTime,'string',testf.parkDef);

set(handles.tvCar,'string',testf.tvCar);
set(handles.tvBus,'string',testf.tvBus);
set(handles.tvBic,'string',testf.tvBic);
set(handles.carCosts,'string',testf.carCosts);
set(handles.parkTic,'string',testf.parkTic);
set(handles.busTic,'string',testf.busTic);
...
testf.parkDef = str2double(get(handles.parkTime,'String'));
testf.carDef = str2double(get(handles.carMult,'String'));
%testf.carDef = config.car_speed_factor;
testf.bikeDef = str2double(get(handles.bikeSpeed,'String'));
%testf.bikeDef = config.bicycle_speed;
testf.walkDef = str2double(get(handles.walkSpeed,'String'));
