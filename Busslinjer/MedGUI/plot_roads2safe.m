...
for i = 1:n_ways %Plottar v�garna mellan noderna, notera att ALLA noder anv�nds (�ven de som inte �r intersection nodes) f�r att rita ut v�garna.
    ...
    if car == 1 && bic==1 && bus==1
        ...
        if data_umea.way(i).cycleway == 1
            set(testf.ch(n_ways + testf.n_one + testf.n_footways + testf.n_pot - i + 1),'Color',handles.c1);
        elseif data_umea.way(i).highway == 1 && data_umea.way(i).bicycle == 0 %&& data_umea.way(i).bus == 0
            set(testf.ch(n_ways + testf.n_one + testf.n_footways + testf.n_pot - i + 1),'Color',handles.c2);
        elseif data_umea.way(i).highway == 0 && data_umea.way(i).bicycle == 1 %&& data_umea.way(i).bus == 0
            set(testf.ch(n_ways + testf.n_one + testf.n_footways + testf.n_pot - i + 1),'Color',handles.c3);
        elseif data_umea.way(i).highway == 0 && data_umea.way(i).bicycle == 0 %&& data_umea.way(i).bus == 1
            set(testf.ch(n_ways + testf.n_one + testf.n_footways + testf.n_pot - i + 1),'Color',handles.c4);
            
        elseif data_umea.way(i).highway == 1 && data_umea.way(i).bicycle == 1 %&& data_umea.way(i).bus == 0
            set(testf.ch(n_ways + testf.n_one + testf.n_footways + testf.n_pot - i + 1),'Color',handles.c5);
        elseif data_umea.way(i).highway == 0 && data_umea.way(i).bicycle == 1 %&& data_umea.way(i).bus == 1
            set(testf.ch(n_ways + testf.n_one + testf.n_footways + testf.n_pot - i + 1),'Color',handles.c6);
        elseif data_umea.way(i).highway == 1 && data_umea.way(i).bicycle == 0 %&& data_umea.way(i).bus == 1
            set(testf.ch(n_ways + testf.n_one + testf.n_footways + testf.n_pot - i + 1),'Color',handles.c7);
            
        elseif data_umea.way(i).highway == 1 && data_umea.way(i).bicycle == 1 %&& data_umea.way(i).bus == 1
            set(testf.ch(n_ways + testf.n_one + testf.n_footways + testf.n_pot - i + 1),'Color',handles.c8);
        %elseif handles.parking==1 && data_umea.way(i).parking == 1
        %   set(testf.ch(n_ways + testf.n_one + testf.n_footways + testf.n_pot - i + 1),'Color',handles.c10);
        elseif  data_umea.way(i).bicycle == 0 && data_umea.way(i).highway == 0 && data_umea.way(i).cycleway == 0%&& data_umea.way(i).bus == 0
            set(testf.ch(n_ways + testf.n_one + testf.n_footways + testf.n_pot - i + 1),'Color',handles.c11);
        else
            set(testf.ch(n_ways + testf.n_one + testf.n_footways + testf.n_pot - i + 1),'Color','k');
        end
...
%         end
    ...
    if one==1 && isfield(testf,'oneline_cre') == 0;
        if data_umea.way(i).oneway == 1;
            ...
            set(testf.ch(n_ways + testf.n_one + testf.n_footways + testf.n_pot - i + 1),'LineStyle', '--');
...
%             
%             
%             %set(testf.ch(n_ways + testf.n_one + testf.n_footways + testf.n_pot - i + 1), '*m','MarkerSize', 20)
%             %                set(line, 'LineStyle', '--');
...
if testf.pot_cre == 0
    ...
    if park == 1 && testf.pot_there == 0;
        for i = 1:testf.n_pot
            set(testf.ch(testf.n_one + testf.n_footways + testf.n_pot - i + 1),'Visible', 'on');
        end
        testf.pot_there = 1;

    elseif park == 0 && testf.pot_there == 1
        for i = 1:testf.n_pot
            set(testf.ch(testf.n_one + testf.n_footways + testf.n_pot - i + 1),'Visible', 'off');
        end
        testf.pot_there = 0;
