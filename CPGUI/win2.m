...
% Last Modified by GUIDE v2.5 10-Nov-2014 11:42:51
...
% Pre-plot settings
set(handles.checkbox2,'Value',1) %Bicycle
set(handles.checkbox3,'Value',1) %Bus
set(handles.checkbox1,'Value',1) %Car
