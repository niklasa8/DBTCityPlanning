textfiles={'Linje1.txt','Linje2.txt','Linje3.txt','Linje4_Degernäs1.txt',...
    'Linje5_ErsforsenN.txt','Linje6.txt','Linje7.txt','Linje8.txt',...
    'Linje9.txt','Linje72.txt','Linje73.txt','Linje75.txt','Linje76_ErsforsenN.txt',...
    'Linje78.txt','Linje80.txt','Linje81.txt'}; %Utan linje 76(Ersmark) och linje 4 (Stöcksjö)

Names={};
IDs={};
file_history=[];
clc
NrTextfiles=size(textfiles)
for i=1:NrTextfiles(2)
