% Generates new datafiles with arrival- and departures times fo all
% buslines. The files are saved/overwritten as ArrDep/Arrivals.mat and
% ArrDep/Departures.mat.
