...
% Last Modified by GUIDE v2.5 06-Jan-2015 21:15:04
...
handles.graph_data = load('graph_data.mat','intnd_count','intnd','intnd_map','id_map','carPath.m','carPath' );
...
% General cost stuff
handles.generalCost = 0;
handles.alpha = 1;      % Timevalue parameter [0,1]
handles.beta = 0.5;       % Actualcost parameter [0,1]
...
%fastest_trip = busTest2(handles.current_node,handles.graph_data,travelTime,handles.current_day);
%generalCost = 0;
%alpha = 1;      % Timevalue parameter [0,1]
%beta = 0.5;       % Actualcost parameter [0,1]
fastest_trip = busTest2(handles.current_node,handles.graph_data,travelTime,handles.current_day,handles.generalCost,handles.alpha,handles.beta);
waitbar(0.5,h);
axes(handles.axes1)

plot_nodes3(fastest_trip,handles,handles.generalCost,handles.alpha,handles.beta)
