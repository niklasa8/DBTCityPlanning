...
%         if bicycling_path(i,handles.graph_data.intnd_map(handles.graph_data.id_map(node_source))) < carPar*(carTo_walkFrom_parking(i,handles.graph_data.intnd_map(handles.graph_data.id_map(node_source))) + 3/60) && bicycling_path(i,handles.graph_data.intnd_map(handles.graph_data.id_map(node_source))) < fastest_trip(i)
%             set(handles.ch(n_ways + nr + n - i + 1),'color','r','visible','on');
%         end
%     end
%     
%     if carPar*(carTo_walkFrom_parking(i,handles.graph_data.intnd_map(handles.graph_data.id_map(node_source))) + 3/60) < bicycling_path(i,handles.graph_data.intnd_map(handles.graph_data.id_map(node_source))) && carPar*(carTo_walkFrom_parking(i,handles.graph_data.intnd_map(handles.graph_data.id_map(node_source))) + 3/60) < fastest_trip(i)
%         set(handles.ch(n_ways + nr + n - i + 1),'color','g','visible','on');
%     end
%     
%     if carTo_walkFrom_parking(i,handles.graph_data.intnd_map(handles.graph_data.id_map(node_source))) ~= inf
%         if fastest_trip(i) < bicycling_path(i,handles.graph_data.intnd_map(handles.graph_data.id_map(node_source))) && fastest_trip(i) < carPar*(carTo_walkFrom_parking(i,handles.graph_data.intnd_map(handles.graph_data.id_map(node_source))) + 3/60)
